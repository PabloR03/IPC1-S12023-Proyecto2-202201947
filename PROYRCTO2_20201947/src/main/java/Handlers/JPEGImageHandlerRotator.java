...
public class JPEGImageHandlerRotator extends ImageHandler {
    ...
    public void generateFiles() throws Exception {
        ...
        ImageIO.write(bmp1, "jpg", new File("C:\\Users\\admin\\Downloads\\Carpeta_Temporal\\VRotation-" + nombreCorto + ".jpg"));
        ...
        ImageIO.write(bmp2, "jpg", new File("C:\\Users\\admin\\Downloads\\Carpeta_Temporal\\HRotation-" + nombreCorto + ".jpg"));
        bmpTemporal2.delete();
    }
