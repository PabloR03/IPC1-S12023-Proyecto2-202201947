...
public class JPEGImageHandlerColors extends ImageHandler{
    ...
    public void generateFiles() throws Exception {
        ...
        ImageIO.write(bmp1, "jpg", new File("C:\\Users\\admin\\Downloads\\Carpeta_Temporal\\Sepia-"+nombreCorto+".jpg"));
        bmpTemporal1.delete();
        ...
        ImageIO.write(bmp2, "jpg", new File("C:\\Users\\admin\\Downloads\\Carpeta_Temporal\\Red-"+nombreCorto+".jpg"));
        bmpTemporal2.delete();
        ...
        ImageIO.write(bmp3, "jpg", new File("C:\\Users\\admin\\Downloads\\Carpeta_Temporal\\Green-"+nombreCorto+".jpg"));
        bmpTemporal3.delete();
        ...
        ImageIO.write(bmp4, "jpg", new File("C:\\Users\\admin\\Downloads\\Carpeta_Temporal\\Blue-"+nombreCorto+".jpg"));
        bmpTemporal4.delete();
