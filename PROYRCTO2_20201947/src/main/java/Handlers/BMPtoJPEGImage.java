...
public class BMPtoJPEGImage extends ImageHandler{
    ...
    public void readFile() throws Exception {
        ...
        jpgTemporal = new File("C:\\Users\\admin\\Downloads\\Carpeta_Temporal\\jpgTemporal.jpg");
    ...
    public void generateFiles() throws Exception {
        ...
        ImageIO.write(bmp, "jpg", new File("C:\\Users\\admin\\Downloads\\Carpeta_Temporal\\Converted-"+nombreCorto+".jpg"));
        jpgTemporal.delete();
    }
